 ...
 */
extern bool json_query_eval(JsonQueryExpr *expr, Jsonb *value,
                            bool *is_null);
 ...
 */
extern void json_query_batch_parse(BatchParseContext *ctx,
 ...
 */
extern void json_query_batch_extract(BatchParseContext *ctx,
