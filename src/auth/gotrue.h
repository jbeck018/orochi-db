...
extern bool orochi_auth_update_user(pg_uuid_t user_id,
                                    const char *email,
                                    const char *phone,
                                    const char *password,
                                    Jsonb *user_metadata,
...
extern OrochiAuthMFAFactor *orochi_auth_enroll_factor(pg_uuid_t user_id,
                                                       OrochiAuthFactorType type,
...
extern OrochiAuthIdentity *orochi_auth_link_identity(pg_uuid_t user_id,
