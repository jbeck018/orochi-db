 ...
 */
extern VectorColumn *vector_batch_add_column(VectorBatch *batch,
                                             int32 column_index,
 ...
 */
extern void vectorized_filter_generic(VectorBatch *batch,
                                      VectorizedFilterState *filter);

/*
 * Combine two selection vectors with AND
 */
extern void vectorized_selection_and(VectorBatch *batch,
 ...
 */
extern int64 vectorized_min_int64(VectorBatch *batch, int32 column_index,
                                  bool *found);

/*
 * Find maximum int64 value
 */
extern int64 vectorized_max_int64(VectorBatch *batch, int32 column_index,
                                  bool *found);

/*
 * Find minimum float64 value
 */
extern double vectorized_min_float64(VectorBatch *batch, int32 column_index,
                                     bool *found);

/*
 * Find maximum float64 value
 */
extern double vectorized_max_float64(VectorBatch *batch, int32 column_index,
                                     bool *found);

/*
 * Update running aggregation state with batch
 */
extern void vectorized_agg_update(VectorizedAggState *state,
                                  VectorBatch *batch);
 ...
 */
extern void vectorized_apply_predicate(VectorizedScanState *state,
                                       VectorBatch *batch);
