...
/* Pool lifecycle */
extern int64 orochi_create_resource_pool(const char *pool_name,
                                         ResourceLimits *limits,
                                         int priority_weight);
extern bool orochi_alter_resource_pool(int64 pool_id,
...
/* Class lifecycle */
extern int64 orochi_create_workload_class(const char *class_name,
                                          int64 pool_id,
                                          QueryPriority default_priority,
                                          ResourceLimits *limits);
extern bool orochi_alter_workload_class(int64 class_id,
                                        int64 pool_id,
...
extern bool orochi_assign_workload_class_by_name(int backend_pid,
...
/* Query admission */
extern bool orochi_admit_query(int backend_pid, int64 pool_id,
                               QueryPriority priority,
                               int64 estimated_cost,
                               int64 memory_requested);
extern bool orochi_queue_query(int backend_pid, int64 pool_id,
                               QueryPriority priority,
                               int64 estimated_cost);
...
/* Session management */
extern bool orochi_register_session(int backend_pid, int64 pool_id,
                                    int64 class_id);
...
extern void orochi_track_session_io(int backend_pid, int64 read_bytes,
                                    int64 write_bytes);
...
/* I/O throttling */
extern bool orochi_governor_check_io_limit(int backend_pid, int64 bytes,
                                           bool is_write);
extern void orochi_governor_track_io(int backend_pid, int64 bytes,
                                     bool is_write);
