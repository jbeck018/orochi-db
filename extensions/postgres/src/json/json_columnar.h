 ...
 */
extern List *json_columnar_extract_columns(Oid table_oid, int16 source_attnum,
                                           const char **paths, int path_count);

/*
 * Auto-detect and extract high-value paths
 */
extern List *json_columnar_auto_extract(Oid table_oid, int16 source_attnum,
                                        int max_columns);
 ...
 */
extern JsonColumnarWriteState *json_columnar_begin_write(Oid table_oid,
                                                         int16 source_attnum);

/*
 * Write a JSON value to extracted columns
 */
extern void json_columnar_write_value(JsonColumnarWriteState *state,
 ...
 */
extern int json_columnar_read_batch(JsonColumnarReadState *state,
 ...
 */
extern JsonColumnarStorageType
json_columnar_select_storage(JsonExtractedColumn *col, Datum *sample_values,
                             int sample_count);
 ...
 */
extern void json_columnar_decompress(const char *compressed,
                                     int64 compressed_size,
                                     JsonColumnarStorageType storage_type,
 ...
 */
extern void json_columnar_build_dictionary(Datum *values, int count,
 ...
 */
extern JsonHybridConfig *json_columnar_get_hybrid_config(Oid table_oid,
                                                         int16 source_attnum);
...
extern JsonColumnarStats *json_columnar_get_stats(Oid table_oid,
                                                  int16 source_attnum);
