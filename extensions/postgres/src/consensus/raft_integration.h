 ...
 */
extern bool orochi_raft_submit_transaction(const char *gid, List *participant_nodes,
 ...
 */
extern void orochi_raft_register_node(int32 node_id, const char *hostname, int port);

/*
 * Add a peer node to the Raft cluster
 */
extern void orochi_raft_add_cluster_node(int32 node_id, const char *hostname, int port);
 ...
 */
typedef void (*RaftTransactionApplyCallback)(const char *gid, const char *command_data,
                                             int32 command_size, void *context);

/*
 * Register callback for applying committed transactions
 */
extern void orochi_raft_set_apply_callback(RaftTransactionApplyCallback callback, void *context);
