...
extern int64 orochi_create_dynamic_table(const char *name, const char *query, Interval *target_lag,
                                         DynamicTableRefreshMode mode, bool initialize);
extern bool orochi_drop_dynamic_table(int64 dynamic_table_id, bool if_exists);
extern bool orochi_alter_dynamic_table(int64 dynamic_table_id, const char *alterations);
...
extern DynamicTable *orochi_get_dynamic_table_by_name(const char *schema, const char *name);
...
extern DynamicTable *ddl_catalog_load_dynamic_table_by_name(const char *schema, const char *name);
...
extern void ddl_catalog_finish_refresh(int64 refresh_id, bool success, const char *error_msg);

/* Dependency tracking */
extern void ddl_catalog_store_source_deps(int64 dynamic_table_id, List *sources);
extern void ddl_catalog_update_source_deps(int64 dynamic_table_id, List *sources);
...
/* Execute refresh */
extern bool dynamic_table_execute_refresh(DynamicTable *dt, DynamicRefreshStats *stats);
extern bool dynamic_table_incremental_refresh(DynamicTable *dt, DynamicRefreshStats *stats);
extern bool dynamic_table_full_refresh(DynamicTable *dt, DynamicRefreshStats *stats);
