...
extern OrochiAuthUser *orochi_auth_create_user(const char *email,
                                               const char *phone,
                                               const char *password,
                                               Jsonb *user_metadata);
...
extern bool orochi_auth_update_user(pg_uuid_t user_id, const char *email,
...
extern OrochiAuthResult *orochi_auth_sign_in_password(const char *email,
                                                      const char *password);

extern OrochiAuthResult *
orochi_auth_sign_in_phone_password(const char *phone, const char *password);
...
/* Password management */
extern bool orochi_auth_update_password(pg_uuid_t user_id,
                                        const char *old_password,
                                        const char *new_password);

extern bool orochi_auth_reset_password(const char *token,
                                       const char *new_password);

/* Password validation */
extern bool orochi_auth_verify_password(const char *password,
...
extern OrochiAuthSession *orochi_auth_create_session(pg_uuid_t user_id,
...
extern char *orochi_auth_generate_jwt(OrochiAuthUser *user,
...
extern OrochiAuthMFAFactor *
orochi_auth_enroll_factor(pg_uuid_t user_id, OrochiAuthFactorType type,
...
extern OrochiAuthMFAChallenge *
orochi_auth_create_challenge(pg_uuid_t factor_id, const char *ip_address);
extern bool orochi_auth_verify_challenge(pg_uuid_t challenge_id,
                                         const char *code);
...
extern OrochiAuthIdentity *
orochi_auth_link_identity(pg_uuid_t user_id, OrochiAuthProvider provider,
