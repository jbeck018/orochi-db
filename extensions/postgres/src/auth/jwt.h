 ...
 */
extern OrochiJwt *orochi_jwt_decode_with_options(const char *token, const char *secret,
                                                 OrochiJwtAlgorithm expected_alg,
 ...
 */
extern bool orochi_jwt_verify_signature(const char *header_payload, const char *signature_b64,
 ...
 */
extern int64 orochi_jwt_get_claim_int(OrochiJwt *jwt, const char *claim_name, bool *is_null);

/*
 * Get claim as boolean
 */
extern bool orochi_jwt_get_claim_bool(OrochiJwt *jwt, const char *claim_name, bool *is_null);
