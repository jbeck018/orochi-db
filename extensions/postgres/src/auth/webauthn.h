...
extern WebAuthnChallenge *webauthn_create_authentication_challenge(const char *user_email,
                                                                   const char *rp_id,
                                                                   const char *origin);
...
extern WebAuthnAuthenticationResult *
...
extern bool webauthn_verify_signature(const uint8 *public_key, int32 public_key_len,
                                      int32 algorithm, const uint8 *authenticator_data,
                                      int32 authenticator_data_len, const uint8 *client_data_hash,
...
extern OrochiWebAuthnCredential *webauthn_get_credential(pg_uuid_t credential_id);
...
extern bool webauthn_revoke_credential(pg_uuid_t user_id, pg_uuid_t credential_id,
                                       const char *reason);

extern bool webauthn_suspend_credential(pg_uuid_t credential_id, const char *reason);
...
extern int32 webauthn_extract_sign_count(const uint8 *authenticator_data, int32 data_len);

extern bool webauthn_extract_flags(const uint8 *authenticator_data, int32 data_len,
                                   bool *user_present, bool *user_verified, bool *backup_eligible,
                                   bool *backup_state);
