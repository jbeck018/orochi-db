...
extern void orochi_create_distributed_table(Oid relid,
                                            const char *distribution_column,
                                            OrochiShardStrategy strategy,
                                            int shard_count);
extern void orochi_create_hypertable(Oid relid, const char *time_column,
...
extern OrochiShardInfo *orochi_get_shard_for_value(Oid table_oid,
                                                   Datum distribution_value);
...
extern void orochi_add_node(const char *hostname, int port,
                            OrochiNodeRole role);
...
extern OrochiJsonPathStats *
orochi_json_analyze_path(Oid table_oid, int16 column_attnum, const char *path);
...
extern List *orochi_json_get_extracted_columns(Oid table_oid,
                                               int16 column_attnum);
