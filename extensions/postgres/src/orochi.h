...
/* Vector operations */
extern void orochi_create_vector_index(Oid relid, const char *column, int dimensions,
...
extern Oid orochi_json_create_index(Oid table_oid, int16 column_attnum, const char **paths,
                                    int path_count, OrochiJsonIndexType index_type);
...
extern OrochiJsonPathStats *orochi_json_analyze_path(Oid table_oid, int16 column_attnum,
                                                     const char *path);
extern List *orochi_json_analyze_all_paths(Oid table_oid, int16 column_attnum);
extern void orochi_json_record_path_access(Oid table_oid, int16 column_attnum, const char *path);

/* JSON Columnar Extraction */
extern List *orochi_json_extract_columns(Oid table_oid, int16 column_attnum, const char **paths,
                                         int path_count);
