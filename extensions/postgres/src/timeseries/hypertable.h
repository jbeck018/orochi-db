...
extern void orochi_create_hypertable(Oid table_oid, const char *time_column,
                                     ...
                                     bool if_not_exists);
extern void orochi_create_hypertable_with_space(Oid table_oid,
...
extern void orochi_register_dimension(Oid hypertable_oid,
...
extern ChunkInfo *orochi_get_chunk_for_timestamp(Oid hypertable_oid,
                                                 TimestampTz ts);
extern ChunkInfo *orochi_get_chunk_for_point(Oid hypertable_oid,
                                             Datum *dimension_values,
                                             int num_dimensions);
extern List *orochi_get_hypertable_chunks(Oid hypertable_oid);
extern List *orochi_get_chunks_in_time_range(Oid hypertable_oid,
                                             TimestampTz start,
                                             TimestampTz end);
extern void orochi_compress_chunk(int64 chunk_id);
extern void orochi_decompress_chunk(int64 chunk_id);
extern int orochi_drop_chunks_older_than(Oid hypertable_oid,
                                         Interval *older_than);
...
extern TimestampTz orochi_time_bucket_offset(Interval *bucket_width,
                                             TimestampTz ts, Interval *offset);
extern TimestampTz orochi_time_bucket_origin(Interval *bucket_width,
                                             TimestampTz ts,
                                             TimestampTz origin);
...
extern void orochi_create_continuous_aggregate(const char *view_name,
                                               const char *query,
                                               Interval *refresh_interval,
                                               bool with_data);
extern void orochi_refresh_continuous_aggregate(Oid view_oid, TimestampTz start,
                                                TimestampTz end);
extern void orochi_set_continuous_aggregate_policy(Oid view_oid,
...
extern void orochi_log_invalidation(Oid hypertable_oid, TimestampTz start,
                                    TimestampTz end);
...
extern void orochi_add_retention_policy(Oid hypertable_oid,
                                        Interval *drop_after);
extern void orochi_remove_retention_policy(Oid hypertable_oid);
extern void orochi_add_compression_policy(Oid hypertable_oid,
                                          Interval *compress_after);
extern void orochi_remove_compression_policy(Oid hypertable_oid);
extern void orochi_enable_compression(Oid hypertable_oid,
                                      const char *segment_by,
                                      const char *order_by);
...
extern List *orochi_get_chunk_exclusion_info(Oid hypertable_oid,
                                             List *predicates);
extern double orochi_estimate_chunk_rows(int64 chunk_id);
extern void orochi_get_chunk_stats(int64 chunk_id, int64 *row_count,
                                   int64 *size_bytes);
...
extern void orochi_create_distributed_hypertable(Oid table_oid,
                                                 const char *time_column,
