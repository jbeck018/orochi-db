...
extern JitExprNode *jit_expr_const_null(JitContext *ctx,
                                        VectorizedDataType type);
 ...
 */
extern JitExprNode *jit_expr_add(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
extern JitExprNode *jit_expr_sub(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
extern JitExprNode *jit_expr_mul(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
extern JitExprNode *jit_expr_div(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
extern JitExprNode *jit_expr_mod(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
 ...
 */
extern JitExprNode *jit_expr_eq(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
extern JitExprNode *jit_expr_ne(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
extern JitExprNode *jit_expr_lt(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
extern JitExprNode *jit_expr_le(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
extern JitExprNode *jit_expr_gt(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
extern JitExprNode *jit_expr_ge(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);

/*
 * Create boolean expression nodes
 */
extern JitExprNode *jit_expr_and(JitContext *ctx, JitExprNode *left,
                                 JitExprNode *right);
extern JitExprNode *jit_expr_or(JitContext *ctx, JitExprNode *left,
                                JitExprNode *right);
 ...
 */
extern JitCompiledExpr *jit_compile_expression(JitContext *ctx,
                                               JitExprNode *expr);
 ...
 */
extern JitCompiledFilter *jit_compile_filter(JitContext *ctx,
                                             JitExprNode *predicate);

/*
 * Compile a simple column comparison filter
 */
extern JitCompiledFilter *
...
extern void jit_vectorized_aggregate(VectorizedAggState *state,
                                     VectorBatch *batch, JitCompiledAgg *agg);
